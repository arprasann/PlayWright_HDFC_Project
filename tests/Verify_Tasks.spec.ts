...
test('Validate Tasks Page @master @sanity @regression',async({ page })=>{
    ...
    await tasks.clickonTasks()

    await tasks.enterFilterTaskByName("Monday")

    await tasks.clickonApplyFilter();
